...
namespace eh {
	...
	public:
		...
		double handle_mean_n_abs_max_(std::string, std::vector<double>);
		...
		double handle_autocorrelation(std::string, std::vector<double>);
		double handle_fft(std::string, std::vector<double>);
